...
function VideoPlayer({ onVideoClick }) { 
  ...
  const API_KEY = 'AIzaSyD9rMfqaNzLtr5CwXVuteYz4fAPWs01OmE'; // Replace with your actual API key
    ...
    const fetchVideos = async (retryCount = 0) => {
      try {
        ...
        const response = await fetch(
          `https://www.googleapis.com/youtube/v3/search?part=snippet&q=bitcoin+crypto&type=video&maxResults=4&order=relevance&key=${API_KEY}`
        );
